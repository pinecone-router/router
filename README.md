...
[![GitHub tag (latest by date)](https://img.shields.io/github/v/tag/pinecone-router/router?color=%2337C8AB&label=version&sort=semver)](https://github.com/pinecone-router/router/tree/5.2.1)
[![npm bundle size](https://img.shields.io/bundlephobia/minzip/pinecone-router?color=37C8AB)](https://bundlephobia.com/result?p=pinecone-router@5.2.1)
...
as of V5.2.1, Pinecone Router now has a navigation stack, keeping track of route visits, and allowing you to do client side back() and forward() operations using the $router magic helper.
...
```js
{handlers: [], templates: '', templateTargetId: 'app'}
```
