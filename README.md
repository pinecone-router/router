...
-   [Render pages](#page-rendering): automatically load server-render pages with preloading (like turbolinks, optional)
...
| ------------------------- | ------- | ------------------------------------------------------------------- |
| **interceptLinks**         | _true_  | hether or not to intercept links                                    |
